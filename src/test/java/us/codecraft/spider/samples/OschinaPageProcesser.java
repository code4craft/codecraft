...
public class OschinaPageProcesser implements PageProcessor {
    ...
    public void process(Page page) {
        ...
        page.putField("title", page.getHtml().xs("//div[@class='QTitle']/h1/a"));
        page.putField("content", page.getHtml().xs("//div[@class='Question']//div[@class='Content']/div[@class='detail']"));
    }

    @Override
    public Site getSite() {
        return Site.me().setDomain("www.oschina.net").setStartUrl("http://www.oschina.net/").setUserAgent("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_7_2) AppleWebKit/537.31 (KHTML, like Gecko) Chrome/26.0.1410.65 Safari/537.31");  //To change body of implemented methods use File | Settings | File Templates.
    }
}
